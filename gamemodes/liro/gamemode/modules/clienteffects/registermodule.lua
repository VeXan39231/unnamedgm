...
local folderName = "clienteffects"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "Alydus","description": "Module that handles clientside effects.","website": "alydus.net","version": "0.1", "blacklistedFiles": [], "networkStrings": [], "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'

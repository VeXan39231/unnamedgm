...
local folderName = "_house_libraries"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "VeXan","description": "Stores libraries that I did make.","website": "na","version": "1.0", "blacklistedFiles": [], "networkStrings": [], "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'

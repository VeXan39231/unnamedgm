...
local folderName = "teams"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "VeXan","description": "Handles team functions.","website": "na","version": "1.0", "blacklistedFiles": [], "networkStrings": [], "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'
